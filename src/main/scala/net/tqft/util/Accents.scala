...
object Accents {
  ...
  def unicodeToLaTeX(s: String) = {
    pairs.foldLeft(s)((t, p) => t.replaceAllLiterally(p._1, p._2))
  }
  def LaTeXToUnicode(s: String) = {
    pairs.foldLeft(s)((t, p) => t.replaceAllLiterally(p._2, p._1))
  }
